...
set CONVOY_LEADER_RX_CHANNEL=3
set CONVOY_LEADER_TX_CHANNEL=4
...
set /a SERIAL_RX_CHANNEL=(INSTANCE * 2) + %CONVOY_LEADER_RX_CHANNEL%
set /a SERIAL_TX_CHANNEL=(INSTANCE * 2) + %CONVOY_LEADER_TX_CHANNEL%
